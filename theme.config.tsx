...
const config: DocsThemeConfig = {
  project: {
    link: 'https://github.com/qdriven/low-code-way'
  },
  docsRepositoryBase: 'https://github.com/qdriven/low-code-waytree/main/',
  useNextSeoProps() {
    const { asPath } = useRouter()
    if (asPath !== '/') {
      return {
        titleTemplate: '%s – Low Code Way'
      }
    }
  },
  logo,
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta
          name="description"
          content="Low Code Way in AI Age."
        />
        <meta
          name="og:description"
          content="Low Code Way in AI Age."
        ...
        <meta
          name="og:title"
          content={title ? title + ' – Low-Code-Way' : 'Low Code Way'}
        />
      ...
      <div className="flex w-full flex-col items-center sm:items-start">
        <div>
          <a
            ...
            href="https://vercel.com?utm_source=low-code-way"
          >
            <span>Powered by</span>
            <svg height={20} viewBox="0 0 283 64" fill="none">
              <title>Vercel/Low Code Way</title>
              <path
                fill="currentColor"
        ...
        <p className="mt-6 text-xs">
          © {new Date().getFullYear()} Low Code Way by Nextra Project.
        </p>
      </div>
    )
  },
