...
- [Taisite-Platform](https://gitee.com/amazingTest/Taisite-Platform.git) Simple CRUD


## Advanced

- [vision-ui](https://github.com/Meituan-Dianping/vision-ui.git) from meituan-dainping, vision ui testing tools, but why?
- [aws=universal-test-runner](https://github.com/aws/universal-test-runner.git) from aws,A universal test runner for any language and test framework.

## Allure Report Tools

- [qameta-Fullstack Test management](https://qameta.io/)
- [allure-testops-utils](https://github.com/eroshenkoam/allure-testops-utils.git)
